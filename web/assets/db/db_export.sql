...
-- Dumping data for table colo-shop.account_type: ~3 rows (approximately)
...
-- Dumping data for table colo-shop.reply: ~1 rows (approximately)
...
-- Dumping data for table colo-shop.review: ~3 rows (approximately)
...
-- Dumping data for table colo-shop.wishlist: ~3 rows (approximately)
