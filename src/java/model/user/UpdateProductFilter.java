...
public class UpdateProductFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        } else if (!fromJson.has("description")) {
            isInvalid = true;
            message = "Description Cannot Be Found";

        } else if (!fromJson.has("unit_price")) {
            isInvalid = true;
            message = "Unit Price Cannot Be Found";

        } else if (!fromJson.has("delivery_fee")) {
            isInvalid = true;
            message = "Delivery Fee Cannot Be Found";

        } else if (!fromJson.has("color")) {
            isInvalid = true;
            message = "Color Cannot Be Found";

        } else if (!fromJson.has("size")) {
            isInvalid = true;
            message = "Size Cannot Be Found";

        } else if (!fromJson.has("category")) {
            isInvalid = true;
            message = "Category Cannot Be Found";

        } else if (!fromJson.has("brand")) {
            isInvalid = true;
