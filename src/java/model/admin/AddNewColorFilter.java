...
@WebFilter(urlPatterns = {"/AddNewColor"})
public class AddNewColorFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        if (httpServletRequest.getSession().getAttribute("admin") == null) {
            ...
            if (request.getParameter("color") == null || request.getParameter("color").isBlank()) {
                //no color
                isInvalid = true;
